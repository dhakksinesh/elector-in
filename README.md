...
* **Testing:** The application includes a comprehensive automated test suite with **15+ unit and integration tests** using **Vitest** and **React Testing Library**. It covers UI rendering, form validation, and API logic.
